...
const Card = ({data} : CardProps) => {
    ...
    const addProductsToCart = async(event: React.MouseEvent<HTMLDivElement>, data: Product) => {
        ...
        if(isInCart){
            ...
            return (
                <div className='absolute top-0 right-0 flex justify-center items-center bg-white w-6 h-6 rounded-full m-2 p-1'
                    onClick={(event: React.MouseEvent<HTMLDivElement>)=>addProductsToCart(event, data)}>
